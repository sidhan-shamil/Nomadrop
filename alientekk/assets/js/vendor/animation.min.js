...
jQuery(function($) {
    ...
    /MSIE|Trident/.test(a) ? ($("[data-aos^=zoom]").css("opacity", "1"), $("[data-aos^=zoom]").css("transform", "scale(1)"), $("[data-aos^=fade]").css("opacity", "1"), $("[data-aos^=fade]").css("transform", "scale(1)")) : AOS.init({
        once: !0
    })
});