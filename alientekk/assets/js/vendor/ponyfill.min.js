! function(e, t) {
    ...
    function n(e) {
        ...
        function u(e, t, n, o) {
            ...
            (function e(t, n, o, a) {
                var c = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : [],
                    ...
                    u = l(t, o, i);
                u.rules.length ? r(u.absoluteUrls, {
                    ...
                    onError: function(r, s, l) {
                        c.push({
                            xhr: r,
                            url: s
                        }), i.push(u.rules[l]), e(t, n, o, a, c, i)
                    },
        ...
        a.length ? a.forEach((function(e, t) {
            ...
            if (l) r(n, {
                ...
                var d = e.textContent;
                s.useCSSOM && (d = Array.apply(null, e.sheet.cssRules).map((function(e) {
                    return e.cssText
                })).join("")), u(d, t, e, location.href)
            } else c[t] = "", i()
        })) : s.onComplete("", [])
    }
    ...
    function l(t) {
        ...
        return "string" == typeof t && (t = u(t, o)), t.stylesheet.rules.forEach((function(e) {
    ...
    function d(e, t) {
        e.rules.forEach((function(r) {
            r.rules ? d(r, t) : r.keyframes ? r.keyframes.forEach((function(e) {
    ...
    function p(t) {
        var r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
            ...
            o = e({}, n, r);
        return "string" == typeof t && (t = u(t, o)), d(t.stylesheet, (function(e, t) {
            for (var r = 0; r < e.length; r++) {
                ...
                if ("declaration" === s)
                    if (o.preserveVars || !a || 0 !== a.indexOf("--")) {
                        if (-1 !== c.indexOf("var(")) {
                            var i = v(c, o);
                            i !== n.value && (i = m(i), o.preserveVars ? (e.splice(r, 0, {
                                type: s,
                                property: a,
                                value: i
                            }), r++) : n.value = i)
    ...
    function j() {
        ...
        if (h) {
            ...
            if (!1 === s.watch && x && (x.disconnect(), x = null), !s.__benchmark) {
                ...
                if (s.__benchmark = V(), s.exclude = [x ? '[data-cssvars]:not([data-cssvars=""])' : '[data-cssvars="out"]', s.exclude].filter((function(e) {
                        return e
                    })).join(","), s.variables = R(s.variables), !x) {
            ...
            if ("loading" !== document.readyState)
                if (y && s.onlyLegacy) {
                ...
                } else !A && (s.shadowDOM || s.rootElement.shadowRoot || s.rootElement.host) ? n({
                    ...
                    onComplete: function(r, n) {
                        var o = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : [],
                            i = e({}, E.dom, E.user);
                        if (E.job = {}, o.forEach((function(e, t) {
                                if (S.cssVars.test(n[t])) try {
                                    var r = u(n[t], {
                            ...
                            })), e(E.job, E.dom), s.updateDOM ? (e(E.user, s.variables), e(E.job, E.user)) : (e(E.job, E.user, s.variables), e(i, s.variables)), g.job > 0 && Boolean(Object.keys(E.job).length > Object.keys(i).length || Boolean(Object.keys(i).length && Object.keys(E.job).some((function(e) {
                                return E.job[e] !== i[e]
                            }))))) B(s.rootElement), j(s);
                        else {
                            var d = [],
                                m = [],
                                v = !1;
                            if (s.updateDOM && g.job++, o.forEach((function(t) {
                                    var r = !t.__cssVars;
                                    if (t.__cssVars) try {
                                        p(t.__cssVars.tree, e({}, s, {
                                            variables: E.job,
                                            onWarning: c
                                        }));
                                        ...
                                        if (s.updateDOM) {
                                            if (t.getAttribute("data-cssvars") || t.setAttribute("data-cssvars", "src"), n.length) {
                                                ...
                                                v = v || S.cssKeyframes.test(n), u.hasAttribute("data-cssvars") || u.setAttribute("data-cssvars", "out"), i === t.textContent.replace(/\s/g, "") ? (r = !0, u && u.parentNode && (t.removeAttribute("data-cssvars-group"), u.parentNode.removeChild(u))) : i !== u.textContent.replace(/\s/g, "") && ([t, u].forEach((function(e) {
                                                    e.setAttribute("data-cssvars-job", g.job), e.setAttribute("data-cssvars-group", o)
                                                })), u.textContent = n, d.push(n), m.push(u), u.parentNode || t.parentNode.insertBefore(u, t.nextSibling))
                                            }
                                ...
                                })), C = s.rootElement.querySelectorAll('[data-cssvars]:not([data-cssvars="out"])').length, s.shadowDOM)
    ...
    function k(e) {
        ...
        window.MutationObserver && (x && (x.disconnect(), x = null), (x = new MutationObserver((function(r) {
            r.some((function(r) {
                var n, o = !1;
    ...
    function T(e, t) {
        return (e.replace(S.cssComments, "").match(S.cssUrls) || []).forEach((function(r) {
